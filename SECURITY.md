...
[GitHub's private advisory form](https://github.com/pulserver/mariepy/security/advisories/new).
...
mariepy is pre-1.0. Fixes land on the default branch and go out in the next
