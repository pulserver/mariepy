...
///////////////////////////////////////////////////////////////////////////
void  Assemble_tri_coupling_matrix_K_y1(mxComplexDouble * Zbc_Nop, double * Scoord, double * r_p, double * r_n, double * r_2, double * wie_quads, double * vie_quads, double res, const size_t N_vox, const size_t N_tri, double ko)
{
    const size_t N2 = 2;
    const size_t N3 = 3;
