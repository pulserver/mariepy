...
void  Assemble_rwg_coupling_matrix_K_x2(mxComplexDouble * Zbc_Nop, double * Scoord, double * r_p, double * r_n, double * r_2, double * r_3, double * sie_quads, double * vie_quads, double res, const size_t N_vox, const size_t N_rwg, double ko)
{
    const size_t N2 = 2;
    const size_t N3 = 3;
